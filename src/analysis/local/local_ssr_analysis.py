...
DEFAULT_CAPTURE_ROOT = PROJECT_ROOT / "results" / "local-ssr"
DEFAULT_GROUND_TRUTH = PROJECT_ROOT / "data" / "source_article.json"
FALLBACK_GROUND_TRUTH = PROJECT_ROOT / "data" / "articles.json"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "results" / "analysis" / "ssr-local"
DEFAULT_FILE_PREFIX = "ssr-local"
